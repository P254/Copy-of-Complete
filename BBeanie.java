...
public class BBeanie extends Applet implements Runnable
{
    ...
    public void init()
    {
        ...
        Image portals1= getImage(getCodeBase(), "portalBlock.gif");
        Image portals2= getImage(getCodeBase(), "portalBlock.gif");
        Image flap= getImage(getCodeBase(), "Flappy.gif");
        Image inv= getImage(getCodeBase(), "invisibleBlock.gif");
        ...
        movingBlockSIDE.setStaticImage(block);
        portalBlock.setStaticImage(portals1);
        invisible.setStaticImage(inv);
    ...
    public void run()
    {
        ...
        while(true)
        {
            ...
            if (Math.abs((int)movingBlock1.getX() -(int)hero.getX()) <30 && Math.abs((int)hero.y- 340) <30 && hero.y <340)
            {

                hero.changeToStand();
            }
            if (Math.abs((int)invisible.getX()-(int)hero.getX()) < 30 && Math.abs(hero.y- invisible.getY())<30)
            {
                hero.changeToStand();
            }
            if (Math.abs((int)portal1.getX()-(int)hero.getX())<20 && Math.abs((int)hero.y-portal1.getY())<20)
            {
                hero.x=portal2.getX()+20;
            }
            if (Math.abs((int)portal2.getX()-(int)hero.getX())<20 && Math.abs((int)hero.y-portal2.getY())<20)
            {
                hero.x=portal1.getX()-20;
            }
            if (hero.y<10)
            {
                hero.y+=30;
    ...
    public void createBarrier(int xVal,int space)
    {
        for (int x=0; x<space;x++)
        {
            grid.setBlock(xVal,space);
        }
        for (int f=space+2;f<grid.MHEIGHT;f++)
        {
            grid.setBlock(xVal,space);
        }
    }
    
    public void createRandom(int xStart)
    {
        int pos=xStart;
        int blocksPerY=(int)(Math.random()*8);
        for (int x=0; x<blocksPerY;x++)
        {
            int yPos=(int)(Math.random()*8+3);
            grid.setBlock(pos,yPos);
        }
    }
    ...
    public void setLevel1()
    {
        ...
        for (int x=35; x<100;x+=3)
        {
            ...
            {
                countBarr++;
                createBarrier(x,(int)(Math.random()*5));
            }
        }
        ...
        movingBlock1= new movingBlockSIDE(this,200,150*2+40,20,60, true);
        portal1= new portalBlock(this,1350,400);
        portal2= new portalBlock(this, 1450,400);
        invisible= new invisibleBlock(this,500,150*2+40);
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawImage(saved_i,800-cut,0,VWIDTH,VHEIGHT,this);
        g.drawImage(saved_i,1200-cut,0,VWIDTH,VHEIGHT,this);
        g.drawImage(saved_i,1600-cut,0,VWIDTH,VHEIGHT,this);
        g.drawImage(saved_i,2000-cut,0,VWIDTH,VHEIGHT,this);
        ...
        portal1.paint(g);
        portal2.paint(g);
        movingBlock1.paint(g);
        g.setColor(Color.black);
        g.setFont(font);
        g.drawString("X: " + hero.x + " Y: " +hero.y,250,25);
